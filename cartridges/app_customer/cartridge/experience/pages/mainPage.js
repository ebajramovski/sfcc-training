...
module.exports.render = function (context) {
    ...
    var metaDefinition = require('*/cartridge/experience/pages/mainPage.json');
    ...
    // render the page
    return new Template('experience/pages/mainPage').render(model).text;
};
